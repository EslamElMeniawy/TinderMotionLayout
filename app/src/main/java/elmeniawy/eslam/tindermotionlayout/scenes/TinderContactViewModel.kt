...
/**
 * TinderContactViewModel
 *
 * Created by Eslam El-Meniawy on 24-Jun-2020 3:04 PM.
 * Roqay
 */
class TinderContactViewModel : ViewModel() {
    ...
    private val data = listOf(
        ...
        TinderContactCardModel(
            name = "CerveChat Dominguez",
            age = 2,
            description = "Esto es una descripcion de ejemplo",
            backgroundColor = Color.parseColor("#c60055")
        ),
        TinderContactCardModel(
            name = "Sofia Jerez Test",
            age = 27,
            description = "Esto es una descripcion de ejemplo",
